...
import sample.cargotracker.registration.impl.RegisterCargo;
 ...
 */
public class DistributionChannelServiceImpl implements RegistrationService {
     ...
     */
    @Inject
    public DistributionChannelServiceImpl(PubSubRegistry topics, PersistentEntityRegistry persistentEntityRegistry, CassandraReadSide readSide,
                                          CassandraSession db) {
        this.persistentEntityRegistry = persistentEntityRegistry;
        this.topics = topics;
        this.db = db;
        persistentEntityRegistry.register(ChannelEntity.class);
    ...
    public ServiceCall<NotUsed, Cargo, Done> register() {
        return (id, request) -> {
            ...
            PersistentEntityRef<DistributionChannelCommand> ref =
                    persistentEntityRegistry.refFor(ChannelEntity.class, request.getId());
