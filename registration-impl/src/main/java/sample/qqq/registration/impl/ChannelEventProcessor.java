...
import sample.cargotracker.registration.impl.CargoRegistered;
 ...
 */
public class ChannelEventProcessor extends CassandraReadSideProcessor<DistributionChannelEvent> {

    private final Logger log = LoggerFactory.getLogger(ChannelEventProcessor.class);

    @Override
    public AggregateEventTag<DistributionChannelEvent> aggregateTag() {
